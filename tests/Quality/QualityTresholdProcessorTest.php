...
class QualityTresholdProcessorTest extends TestCase
{
    public function testWrongAction()
    {
        ...
        new QualityTresholdProcessor(['min' => 0, 'max' => 1, 'action' => '--missing-action--', 'value' => 0]);
    }
    ...
    public function testValueRequired()
    {
        ...
        new QualityTresholdProcessor(['min' => 0, 'max' => 1, 'action' => ActionType::SET]);
    }
    ...
    public function testProcessing($name, $sell_in, $quality, $expectedSupports, $expectedQuality, $procOptions)
    {
        ...
        $proc = new QualityTresholdProcessor($procOptions);
    ...
    {
        return [
            'Below range' => ['foo', 1, 1, false, 0, ['min' => 2, 'max' => 4, 'value' => 3, 'action' => ActionType::SET]],
            'Set 3'       => ['foo', 1, 2,  true, 3, ['min' => 2, 'max' => 4, 'value' => 3, 'action' => ActionType::SET]],
            'Add 3'       => ['foo', 1, 3,  true, 6, ['min' => 2, 'max' => 4, 'value' => 3, 'action' => ActionType::INCREMENT]],
            'Sub 3'       => ['foo', 1, 4,  true, 1, ['min' => 2, 'max' => 4, 'value' => 3, 'action' => ActionType::DECREMENT]],
